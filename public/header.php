    ...
    <div class="collapse navbar-collapse justify-content-center" id="navbarColor01">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item événements">
                <a class="nav-link" href="envents.php"><span class="événements">Evénements entre Wilders</span><span
                            class="bar ml-3"></span></a>
            </li>


            <li class="nav-item vie">
                <a class="nav-link" href="wildlife.php"><span class="vie a la wild">La vie à la Wild</span><span
                            class="bar ml-3"></span></a>
            </li>
